...
if vim.o.background == 'light' then
    ...
    hi('StatusLineTerm',
        { fg = 'White', bg = 'DarkGreen', bold = true, ctermfg = 'White', ctermbg = 'DarkGreen', cterm = { bold = true } })
    hi('StatusLineTermNC', { fg = 'White', bg = 'DarkGreen', ctermfg = 'White', ctermbg = 'DarkGreen' })
    hi('TabLine',
        { bg = 'LightGrey', underline = true, ctermfg = 'Black', ctermbg = 'LightGrey', cterm = { underline = true } })
    ...
    hi('Underlined',
        { fg = 'SlateBlue', underline = true, ctermfg = 'DarkMagenta', cterm = { underline = true } })
    ...
    hi('Pmenu', { fg = 'Black', bg = 'White', ctermfg = 'Black', ctermbg = 'White' })
    ...
    hi('Underlined',
        { fg = '#80a0ff', underline = true, ctermfg = 'LightBlue', cterm = { underline = true } })
